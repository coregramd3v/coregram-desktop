...
// CoreGram: per-server recent custom emoji, kept in a small standalone JSON file
// (tdata/coregram_recent_emoji.json) instead of the versioned serialize() blob above,
...
[[nodiscard]] QString RecentEmojiScopeFilePath() {
	return cWorkingDir() + u"tdata/coregram_recent_emoji.json"_q;
}
